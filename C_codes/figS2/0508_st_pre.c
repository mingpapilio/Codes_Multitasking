...
/* To execute
 ...
 gcc 0508_st_pre.c gen_beta.h gen_beta.c -lm -stdlib=libstdc++
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int main(void){
	...
	// Stochasticity generators
		...
		double o_coe= 0.15;						// Coefficient of clutch-size dependent nest predation
